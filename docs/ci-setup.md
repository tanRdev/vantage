...
Performance Enforcer integrates with GitHub Actions to automatically run performance checks on pull requests and post results.
...
*Generated by Performance Enforcer*
```
