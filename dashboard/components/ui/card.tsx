...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg bg-card/60 text-card-foreground backdrop-blur-md border border-border/50",
      "shadow-lg",
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-none tracking-tight text-all-caps-tight",
      className
    )}
    {...props}
  />
