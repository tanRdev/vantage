...
describe("ThresholdEngine", () => {
  ...
  describe("compareRuntimeMetric", () => {
    ...
    it("should pass when threshold is not defined", () => {
      const result = ThresholdEngine.compareRuntimeMetric(5000, thresholds, "tbt" as any);
  ...
  describe("calculateScore", () => {
    it("should calculate score correctly", () => {
      const results = [
        { passed: true, delta: 0, status: "pass" as any },
        { passed: true, delta: 0, status: "pass" as any },
        { passed: false, delta: 100, status: "fail" as any },
        { passed: true, delta: 0, status: "pass" as any },
      ];
  ...
  describe("shouldBlockPR", () => {
    ...
    it("should not block when only warnings", () => {
      const results = [
        { passed: true, delta: 0, status: "pass" as any },
        { passed: true, delta: 0, status: "warn" as any },
      ];
